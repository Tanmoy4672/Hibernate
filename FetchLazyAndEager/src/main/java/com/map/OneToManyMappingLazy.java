...
public class OneToManyMappingLazy {
...
//		QuestionTable ques1 = new QuestionTable();
...
//
		...
		//data fetching by lazy loading(Lazy loading always in Default version)
		QuestionTable newQ = (QuestionTable)session.get(QuestionTable.class, 1212);
