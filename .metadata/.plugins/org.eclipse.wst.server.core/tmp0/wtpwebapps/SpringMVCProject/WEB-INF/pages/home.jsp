		...
		<div class="row mt-5">
			...
			<div class="col-md-2">
				<div class="list-group">
					<a type="button" onclick="getPosts(0, this)"
						class="c-link list-group-item list-group-item-action active"
						aria-current="true">Menu</a>
					<a href="<c:url value='/add'></c:url>" onclick="getPosts(1, this)"
						class="c-link list-group-item list-group-item-action">Add TODO</a> 
						
						<a
						href="<c:url value='/home'></c:url>" onclick="getPosts(2, this)"
						class="c-link list-group-item list-group-item-action">View TODOs</a>
				</div>
			</div>
			<div class="col-md-10">
				<c:if test="${page=='home' }">
